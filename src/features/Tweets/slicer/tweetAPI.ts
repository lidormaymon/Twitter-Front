...
export const postTweet = (text:string, user_id:number) => {
...
export const postCommentAPI = (text:string, user_id:number, tweet_id:number, comments:number) => {
    const data = { text, user_id, tweet_id}
